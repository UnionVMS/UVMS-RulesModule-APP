...
@LocalBean
@Slf4j
public class ReceiveSalesReportRequestMessageBean extends RulesMessageBase{
    ...
    void processMessage(RulesMessageEvent message, String username) throws Exception {
        ReceiveSalesResponseRequest receiveSalesReportRequest = (ReceiveSalesResponseRequest) message.getRequest();
        rulesService.receiveSalesResponseRequest(receiveSalesReportRequest);
    }
}
