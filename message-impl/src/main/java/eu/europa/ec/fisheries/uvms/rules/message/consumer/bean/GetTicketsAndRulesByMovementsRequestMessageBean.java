...
@LocalBean
@Slf4j
public class GetTicketsAndRulesByMovementsRequestMessageBean extends RulesMessageBase {
    ...
    void processMessage(RulesMessageEvent message, String username) throws Exception {
        GetTicketsAndRulesByMovementsRequest request = (GetTicketsAndRulesByMovementsRequest) message.getRequest();
