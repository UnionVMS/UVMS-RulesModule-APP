...
@LocalBean
@Slf4j
public class SetFLUXMDRSyncMessageRulesResponseMessageBean extends RulesMessageBase {
    ...
    @Override void processMessage(RulesMessageEvent message, String username) throws Exception {
        SetFLUXMDRSyncMessageRulesResponse request = (SetFLUXMDRSyncMessageRulesResponse) message.getRequest();
