...
@LocalBean
@Slf4j
public class CountTicketsByMovementsRequestMessageBean extends RulesMessageBase {
    ...
    @Override void processMessage(RulesMessageEvent message, String username) throws Exception {
        CountTicketsByMovementsRequest request = (CountTicketsByMovementsRequest) message.getRequest();
