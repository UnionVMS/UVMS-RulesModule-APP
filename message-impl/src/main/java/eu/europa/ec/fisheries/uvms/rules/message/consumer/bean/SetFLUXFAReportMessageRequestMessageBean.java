...
@LocalBean
@Slf4j
public class SetFLUXFAReportMessageRequestMessageBean extends RulesMessageBase {
    ...
    @Override void processMessage(RulesMessageEvent message, String username) throws Exception {
        ...
        SetFLUXFAReportMessageRequest request = (SetFLUXFAReportMessageRequest) message.getRequest();
        log.info("marshall SetFLUXFAReportMessageRequest successful");
        rulesService.setFLUXFAReportMessageReceived(request);
    }
}
