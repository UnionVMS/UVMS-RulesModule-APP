...
@LocalBean
@Slf4j
public class SetFLUXMDRSyncMessageRulesRequestMessageBean extends RulesMessageBase {
    ...
    @Override void processMessage(RulesMessageEvent message, String username) throws Exception {
        log.info("@SetFLUXMDRSyncMessageReceivedEvent received inside Rules Module.");
        SetFLUXMDRSyncMessageRulesRequest request = (SetFLUXMDRSyncMessageRulesRequest) message.getRequest();
