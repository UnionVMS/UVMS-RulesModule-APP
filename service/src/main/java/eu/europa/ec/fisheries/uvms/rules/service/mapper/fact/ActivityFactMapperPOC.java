...
public class ActivityFactMapperPOC {
    ...
    public FishingActivityFact generateFactForFishingActivity(FishingActivity fishingActivity, FAReportDocument faReportDocument) {
        ...
        fishingActivityFact.setRelatedFishingTrip(CustomMapper.mapRelatedFishingTrips(relatedFishingActivities));
        ...
        fishingActivityFact.setRelatedFishingActivityCodeTypes(CustomMapper.mapFromFishingActivityListToCodeTypeList(relatedFishingActivities));
        xPathUtil.appendWithoutWrapping(partialXpath).append(RELATED_FISHING_ACTIVITY, SPECIFIED_FISHING_TRIP).storeInRepo(fishingActivityFact, "relatedFishingActivityCodeTypes");
