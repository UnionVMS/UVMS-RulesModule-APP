...
public enum DrtPathHelper {
    ...
    FA_VALIDATION_RESULT_DOCUMENT("/templates/FaValidationResultDocument.drt"),
    ...
    SALES_VALIDATION_RESULT_DOCUMENT("/templates/SalesValidationDocument.drt"),
    SALES_VALIDATION_QUALITY_ANALYSIS("/templates/SalesQualityAnalysis.drt"),
