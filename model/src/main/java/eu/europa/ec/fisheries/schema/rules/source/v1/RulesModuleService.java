 ...
 * 2016-03-22T17:13:50.078+01:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "RulesModuleService", 
                  wsdlLocation = "file:/C:/slask/Rules/APP/model/src/main/resources/contract/RulesDataSourceService.wsdl",
...
public class RulesModuleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/slask/Rules/APP/model/src/main/resources/contract/RulesDataSourceService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RulesModuleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/slask/Rules/APP/model/src/main/resources/contract/RulesDataSourceService.wsdl");
        }
        WSDL_LOCATION = url;
    }
